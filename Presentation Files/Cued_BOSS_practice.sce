...
pcl_file = "Cued_BOSS_practice.pcl";
begin;


bitmap { filename = "A_1.png";   width = 400; height = 400; preload = true;} A_1;
...
bitmap { filename = "instruction_1.png";   width = 700; height = 400; preload = true;} instruction_1;
bitmap { filename = "instruction_2.png";   width = 700; height = 400; preload = true;} instruction_2;
bitmap { filename = "instruction_3.png";   width = 700; height = 400; preload = true;} instruction_3;
bitmap { filename = "instruction_4.png";   width = 700; height = 400; preload = true;} instruction_4;
...
picture { } pic_s1;
picture { } pic_s2;
picture { bitmap instruction_1; x = 0; y = 0;} instr_1;
picture { bitmap instruction_2; x = 0; y = 0;} instr_2;
picture { bitmap instruction_3; x = 0; y = 0;} instr_3;
picture { bitmap instruction_4; x = 0; y = 0;} instr_4;

trial{ #This is to explain Animal animal
...
trial{ #this is to explain Animal Plant
  trial_duration = forever;        	   # trial lasts until target
   trial_type = specific_response;   	#   button is pressed
	terminator_button = 1;   
   picture instr_2;
...
trial{ #this is to explain Plant Plant
  trial_duration = forever;        	   # trial lasts until target
   trial_type = specific_response;   	#   button is pressed
	terminator_button = 1;   
   picture instr_3;
...
trial{ #this is the first screen to prepare people 
  trial_duration = forever;        	# trial lasts until target
   trial_type = specific_response;   	#   button is pressed
	terminator_button = 1;   
   picture {
		text {font_size=25; font="Arial"; caption ="Please double click to start the practice rounds"; font_color = 0,0,0;};
      x=0;y=0;};
}trial_start_button;
...
trial{
    ...
    #stimulus_time_out = 1100; # 300-1100 ms after the stimulus (so all the time of the first picture)
} start_trial;
...
trial { 
    trial_duration = 1400; #is being overwritten in the PCL  
    picture empty;
    code = "isi_go";
